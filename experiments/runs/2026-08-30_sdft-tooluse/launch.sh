#!/usr/bin/env bash
# Re-run of 2026-08-30_sdft-tooluse — generated at launch by sdft/runlog.py.
#   typed:   experiments/launch/2026-08-30_sdft-tooluse-a6000.sh 
#   host:    jong    cwd: /home/user/jjkim/Self-Distillation
#   python:  /home/user/jjkim/.envs/jjkim_distillation/bin/python
# Usage: bash experiments/runs/2026-08-30_sdft-tooluse/launch.sh [--name <label>] [extra main.py args]
...
SHA=387e5d2df1fd1c7e8bb044f5a8534d644e51cca1
...
export SDFT_LAUNCHER=/home/user/jjkim/Self-Distillation/experiments/launch/2026-08-30_sdft-tooluse-a6000.sh
export SDFT_LAUNCH_CMD='experiments/launch/2026-08-30_sdft-tooluse-a6000.sh '
...
exec "${PYTHON:-/home/user/jjkim/.envs/jjkim_distillation/bin/python}" main.py --dataset_name tooluse --name sdft-tooluse-rerun --model_name Qwen/Qwen3-4B --use_lora --save_lora_adapter_only --learning_rate 5e-5 --num_train_epochs 2 --save_steps 30 --max_prompt_length 2048 --max_completion_length 1024 --vllm_gpu_memory_utilization 0.4 --gradient_checkpointing --eval_steps 30 --eval_num_samples 100 --eval_max_new_tokens 1024 --wandb_project self-distillation --group sdft-3ds --tags baseline "$@"
