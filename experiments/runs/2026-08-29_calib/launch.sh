#!/usr/bin/env bash
# Re-run of 2026-08-29_calib — generated at launch by sdft/runlog.py.
#   typed:   ./experiments/launch/2026-08-29_calib-kkp-a6000.sh 
#   host:    jong    cwd: /home/user/jjkim/Self-Distillation
#   python:  /home/user/.envs/jjkim_distillation/bin/python
# Usage: bash experiments/runs/2026-08-29_calib/launch.sh [--name <label>] [extra main.py args]
...
SHA=80e8205b0f556e68ecf7bb4ca1ee4eb301899e02
...
export SDFT_LAUNCHER=/home/user/jjkim/Self-Distillation/experiments/launch/2026-08-29_calib-kkp-a6000.sh
export SDFT_LAUNCH_CMD='./experiments/launch/2026-08-29_calib-kkp-a6000.sh '
...
exec "${PYTHON:-/home/user/.envs/jjkim_distillation/bin/python}" main.py --dataset_name kkp --name calib-rerun --model_name Qwen/Qwen3-4B --use_lora --save_lora_adapter_only --learning_rate 5e-5 --num_train_epochs 0.05 --save_steps 10 --max_prompt_length 5120 --max_completion_length 4096 --vllm_gpu_memory_utilization 0.25 --gradient_checkpointing --eval_steps 5 --eval_num_samples 100 --eval_max_new_tokens 4096 --wandb_project self-distillation --eval_num_samples 20 --tags calib "$@"
