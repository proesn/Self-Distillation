#!/usr/bin/env bash
# Re-run of 2026-08-31_eval-science-teacher-view — generated at launch by sdft/runlog.py.
...
# Usage: bash experiments/runs/2026-08-31_eval-science-teacher-view/launch.sh [--name <label>] [extra main.py args]
...
exec "${PYTHON:-/home/user/jjkim/.envs/jjkim_distillation/bin/python}" eval_science.py --model_path Qwen/Qwen3-4B --name eval-science-teacher-view-rerun --output_dir eval_results/eval-science-teacher-view --teacher_view --num_samples 300 --seed 42 --temperature 0.0 --max_new_tokens 2048 --max_model_len 8192 "$@"
