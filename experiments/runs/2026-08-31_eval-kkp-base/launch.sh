#!/usr/bin/env bash
# Re-run of 2026-08-31_eval-kkp-base — generated at launch by sdft/runlog.py.
...
# Usage: bash experiments/runs/2026-08-31_eval-kkp-base/launch.sh [--name <label>] [extra main.py args]
...
exec "${PYTHON:-/home/user/jjkim/.envs/jjkim_distillation/bin/python}" eval_kkp.py --model_path Qwen/Qwen3-4B --name eval-kkp-base-rerun --output_dir eval_results/eval-kkp-base --seed 42 --temperature 0.0 --max_new_tokens 8192 --max_model_len 16384 --max_new_tokens 4096 "$@"
